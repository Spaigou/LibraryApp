...
public class EditLibraryFrame extends JPanel implements ActionListener{
    ...
    public EditLibraryFrame(String[] data){
        super();
        ...
        floor_text = new JTextField(data[1]);
        wardrobe_text = new JTextField(data[2]);
        shelf_text = new JTextField(data[3]);
