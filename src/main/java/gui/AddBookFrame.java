...
public class AddBookFrame extends JPanel implements ActionListener {
    ...
    public AddBookFrame(){
        ...
        publication_label = new JLabel("Название книги");
        ...
        publication_text = new JTextField();
        publishing_house_text = new JTextField();
        year_public_text = new JTextField();
        pages_text = new JTextField();
        year_write_text = new JTextField();
        weight_text = new JTextField();
        id_place_text = new JTextField();
